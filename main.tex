...
\usepackage{lmodern}
\usepackage[size=custom,width=120,height=72]{beamerposter}
\usetheme{gemini}
\usecolortheme{neu}
\usepackage{graphicx}
\usepackage{booktabs}
...
\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
      ...
      {\includegraphics[height=8.0cm]{logos/logo-neu.png}}; % also try shield-white.eps
    %   \node [anchor=north east, inner sep=3cm] at ([xshift=0.0cm,yshift=2.5cm]current page.north east)
    %   {\includegraphics[height=8.0cm]{logos/logo-left.png}};
    \end{tikzpicture}
}
